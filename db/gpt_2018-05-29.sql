...
# Database: gpt
# Generation Time: 2018-05-29 15:18:47 +0000
# ************************************************************
...
# Dump of table gpt_admin
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gpt_admin`;

CREATE TABLE `gpt_admin` (
...
LOCK TABLES `gpt_admin` WRITE;
/*!40000 ALTER TABLE `gpt_admin` DISABLE KEYS */;

INSERT INTO `gpt_admin` (`user_id`, `username`, `email`, `name`, `banned`, `passwd`, `passwd_recovery_code`, `passwd_recovery_date`, `passwd_modified_at`, `last_login`, `created_at`, `modified_at`)
VALUES
	(1,'gpt_admin','shahzad.fatehali@gmail.com','Shahzad Fateh Ali',0,'$2y$10$EQQGHplnt8e8Y/g//l7fZuT9YMRqFzNyJHDpR2Lm6z9tdRsPf44N.',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00','2018-05-29 11:51:26');

/*!40000 ALTER TABLE `gpt_admin` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 CREATE */ /*!50017 DEFINER=`gpt`@`%` */ /*!50003 TRIGGER `ca_passwd_trigger` BEFORE UPDATE ON `gpt_user` FOR EACH ROW BEGIN
...
# Dump of table gpt_user_role
# ------------------------------------------------------------

DROP TABLE IF EXISTS `gpt_user_role`;

CREATE TABLE `gpt_user_role` (
