...
alter table gpt_patient_contact_address modify column zipcode varchar(20);
alter table gpt_company_contact_address modify column zipcode varchar(20);
alter table gpt_hospital_contact_address modify column zipcode varchar(20);
