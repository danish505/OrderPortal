 ...
 */
class GptCompanyContact extends \GptCompanyContact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GptCompanyContact' . "\0" . 'contId', '' . "\0" . 'GptCompanyContact' . "\0" . 'salutation', '' . "\0" . 'GptCompanyContact' . "\0" . 'firstName', '' . "\0" . 'GptCompanyContact' . "\0" . 'middleName', '' . "\0" . 'GptCompanyContact' . "\0" . 'lastName', '' . "\0" . 'GptCompanyContact' . "\0" . 'jobTitle', '' . "\0" . 'GptCompanyContact' . "\0" . 'jobFunction', '' . "\0" . 'GptCompanyContact' . "\0" . 'jobRole', '' . "\0" . 'GptCompanyContact' . "\0" . 'activeFlg', '' . "\0" . 'GptCompanyContact' . "\0" . 'createTs', '' . "\0" . 'GptCompanyContact' . "\0" . 'updateTs', '' . "\0" . 'GptCompanyContact' . "\0" . 'company', '' . "\0" . 'GptCompanyContact' . "\0" . 'addresses', '' . "\0" . 'GptCompanyContact' . "\0" . 'emails', '' . "\0" . 'GptCompanyContact' . "\0" . 'phone_numbers'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GptCompanyContact $proxy) {
