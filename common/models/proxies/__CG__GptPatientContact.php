 ...
 */
class GptPatientContact extends \GptPatientContact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GptPatientContact $proxy) {
    ...
    public function setPrimary()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPrimary', []);

        return parent::setPrimary();
    }
