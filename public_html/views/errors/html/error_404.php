				...
				<div class="navbar-left">
					<div class="collapse navbar-collapse" id="navbar-collapse">
						<ul class="nav navbar-nav">
							<li <?php if ($this->router->fetch_class() == 'main') {
    echo 'class="active"';
} ?>><a href="<?php echo base_url(''); ?>">Home</a></li>
							<li class="tr-dropdown <?php if ($this->router->fetch_class() == 'jobs') {
    echo 'active';
} ?>"><a href="#" onclick="event.preventDefault();">Jobs</a>
								<ul class="tr-dropdown-menu tr-list fadeInUp" role="menu">
							        <li <?php if ($this->router->fetch_class() == 'jobs' && $this->router->fetch_method() != 'category_list' && $this->router->fetch_method() != 'city_list') {
    echo 'class="active"';
} ?>><a href="<?php echo base_url('jobs'); ?>">All Jobs</a></li>
							        <li <?php if ($this->router->fetch_class() == 'jobs' && $this->router->fetch_method() == 'category_list') {
    echo 'class="active"';
} ?>><a href="<?php echo base_url('jobs/categories'); ?>">Jobs by Category</a></li>
							        <li <?php if ($this->router->fetch_class() == 'jobs' && $this->router->fetch_method() == 'city_list') {
    echo 'class="active"';
} ?>><a href="<?php echo base_url('jobs/cities'); ?>">Jobs by City</a></li>
								</ul>
							</li>
							<li <?php if ($this->router->fetch_class() == 'resources') {
    echo 'class="active"';
} ?>><a href="<?php echo base_url('resources'); ?>">Resources</a></li>
							<li <?php if ($this->router->fetch_class() == 'statics' && $this->router->fetch_method() == 'contact') {
    echo 'class="active"';
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="found-image">
							<img src="<?php echo $base_url; ?>'assets/images/others/404.jpg'; ?>" alt="Image" class="img-responsive">
						</div>
					</div>
					<div class="col-sm-8">
