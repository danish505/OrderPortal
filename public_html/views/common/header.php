        ...
        <div class="col-lg-9 col-sm-12">
          <div class="row border-bottom h-50 align-items-center d-none d-lg-block">
            <ul class="nav" style="padding-left: 8px;">
              ...
              <li class="nav-item"><a class="nav-link active" href="<?php echo $base_url;?>my-account">My Account</a></li>
              <li class="nav-item"><a class="nav-link" href="<?php echo $base_url;?>logout">Logout</a></li>
            <?php else: ?>
              <li class="nav-item"><a class="nav-link active" href="<?php echo $base_url;?>register-patient">Register</a></li>
