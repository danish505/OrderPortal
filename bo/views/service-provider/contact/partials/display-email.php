<div class="row pb-2 single-email" data-id="<?php echo $email->getId();?>" id="row-email-<?php echo $email->getId();?>">
    ...
    <div class="col-4">
        <div class="btn-group float-right" role="group">
            ...
            <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#deleteConfirmationModal" data-for="email"><i class="fa fa-fw fa-trash"></i></button>
        </div>
    </div>
</div>