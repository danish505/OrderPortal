<tr id="service_provider_<?php echo $serviceProvider->getId();?>" data-id="<?php echo $serviceProvider->getId();?>">
    ...
    <td>
      ...
      <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-for="service_provider" data-target="#deleteConfirmationModal"><i class="fa fa-fw fa-trash"></i></button>
    </td>
  </tr>