    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="action" value="service_provider_service_update" />
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn_service_provider_service_update">Update Service</button>
            </div>
        </div>
    </div>
</div>