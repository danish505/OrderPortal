    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Update Service Provider</h5>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="action" value="service_provider_update" />
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn_service_provider_update">Update Service Provider</button>
            </div>
        </div>
    </div>
</div>