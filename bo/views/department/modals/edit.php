        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="department_name" class="col-sm-4 col-form-label">Name</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="department_name" name="department_name" value="" required>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn_department_update">Update Department</button>
            </div>
        </div>
    </div>
</div>