                    ...
                    <div class="card-body address-list">
                        ...
                        if($addresses && count($addresses)){
                            ...
                            foreach($addresses as $address){
                                $this->load->view('contact/partials/display-address',['address'=>$address]);
                            }
                        }
                        ?>
                    ...
                    <?php 
                        ...
                        if($emails && count($emails)){
                            ...
                            foreach($emails as $email){
                                $this->load->view('contact/partials/display-email',['email'=>$email]);
                            }
                        }
                        ?>
                    ...
                    <?php 
                        ...
                        if($phone_numbers && count($phone_numbers)){
                            foreach($phone_numbers as $phone_number){
                                $class='d-none';
                                $this->load->view('contact/partials/display-phone',['phone_number'=>$phone_number]);
                            }
                        }
                        ?>
